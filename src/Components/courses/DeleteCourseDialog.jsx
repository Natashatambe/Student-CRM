      ...
      <DialogContent onClose={() => setOpen(false)} className="max-w-md">
        <DialogHeader className="bg-red-900 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle className="text-lg font-extrabold text-white">Delete Course Track</DialogTitle>
        ...
        <DialogBody>
          <p className="text-sm font-semibold text-slate-700 leading-relaxed">
            Are you sure you want to delete <strong className="text-[#1E3932] font-extrabold">{course.name}</strong>? Students currently enrolled in this track may be affected.
          </p>
        </DialogBody>
